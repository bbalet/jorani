...
<thead>
    <tr>
      ...
      <th><?php echo lang('leavetypes_type_thead_color');?></th>
    </tr>
  </thead>
  <tbody>
  <?php foreach ($leavetypes as $type) { ?>
    <tr>
	  ...
	  <td style="border-width: 1px;"><div style="height: 100%; width: 95%; padding: 5px; background-color: <?php echo($type['color']); ?>;"></div></td>
    </tr>
  <?php } ?>
