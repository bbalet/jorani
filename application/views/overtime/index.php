...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="leaves" width="100%">
    <thead>
        <tr>
            ...
            <th><?php echo lang('overtime_index_thead_startdate');?></th>
            <th><?php echo lang('overtime_index_thead_enddate');?></th>            
            <th><?php echo lang('overtime_index_thead_duration');?></th>
            <th><?php echo lang('overtime_index_thead_description');?></th>
        </tr>
    </thead>
    <tbody>
...
<div id="modal-from-dom" class="modal hide fade">
    <div class="modal-header">
        <a href="#" class="close">&times;</a>
         <h3>Delete overtime declaration</h3>
    </div>
    <div class="modal-body">
        <p>You are about to delete one overtime declaration, this procedure is irreversible.</p>
