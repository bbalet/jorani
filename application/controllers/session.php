    ...
    public function login() {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            if ($this->config->item('ldap_enabled')) {
                ...
                // Priority is given to the base DN defined into the database if config allows it, then try with the template
                if (
                    !$this->config->item('ldap_basedn_db') //Config disallow use base DN
